...
import img3 from "../assets/istockphoto-1182187147-612x612.jpg";
        ...
        <div className="carousel w-full h-[700px] mt-4">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0">
                    <div className='text-white space-y-7 w-3/5 pl-28 text-green-500'>
                        <h2 className='text-7xl font-bold'>"Play With Your Favorite Toys"</h2>
